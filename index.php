...
<body>
        ...
        <!-- Introduction section -->
            <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                    <h1 style="font-size:50px;color:black"><u><i>SPARKS BANKING SYSTEM</i></u></h1>
                </div>
            </div>
        </div>
        <!-- Activity section -->
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>GARGI PURANDARE</b> <br> For the Project of  <b>The Sparks Foundation</b></p>
    </footer>
